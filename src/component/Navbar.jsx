          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-ink/40 hover:text-ink transition flex items-center justify-center h-8 w-8 rounded-lg hover:bg-ink/5 focus:outline-none"
              >
                {showPassword ? (
