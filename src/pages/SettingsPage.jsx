  ...
  return (
    <div className="fade-in grid grid-cols-1 lg:grid-cols-[240px_1fr] gap-6">
      ...
      <div className="space-y-5">
        {tab === "general" && <Card><h3 className="font-display text-2xl mb-1">Organization</h3><p className="text-sm text-ink/60 mb-6">Basic details about your EduThrive360 workspace.</p><div className="grid grid-cols-1 md:grid-cols-2 gap-5"><div><label className="text-xs uppercase tracking-wider text-ink/50 font-semibold">Organization name</label><Input className="mt-1.5" defaultValue="EduThrive360 — India Region"/></div><div><label className="text-xs uppercase tracking-wider text-ink/50 font-semibold">Support email</label><Input className="mt-1.5" icon={<IconMail size={16}/>} defaultValue="support@eduthrive.io"/></div></div></Card>}
